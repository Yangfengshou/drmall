        ...
        <div class="browse">
            ...
            <ul>
                <?php if(is_array($goods)): foreach($goods as $key=>$v): ?><li>
                    <div class="li-top">
                        <a href="<?php echo U('Goods/goodsdetail',array(gid=>$v[goods_id]));?>" title="<?php echo ($v[goods_name]); ?>" class="li-top-tu"><img style="width: 120px;height: 120px;" src="/drmall/Public/home/upload/300/thumb_300_<?php echo ($v["goods_pic"]); ?>" /></a>
                        <p class="jiage"><span class="sp1">￥<?php echo ($v["goods_price"]); ?></span><span class="sp2">￥<?php echo ($v["goods_marketprice"]); ?></span></p>
                    </div>
                    <a href="#" class="miaoshu"><?php echo mb_substr($v['goods_name'],0,14,'utf8');?></a>
                    <p class="weike">鄂尔多斯官方旗舰店自营</p>
