...
<!--内容开始-->
    <div class="cart-content w1200">
        ...
        <div class="cart-con-info">
        	<div class="info-top">
            	<input type="checkbox" value="" name="hobby" class="sjqx">
				<span>商家：向东服饰专卖店</span>
            </div>
            <div class="info-mid">
            	<input type="checkbox" value="" name="hobby" class="mid-ipt f-l">
                <div class="mid-tu f-l">
                	<a href="#"><img src="/drmall/Public/home/images/dai1.gif" /></a>
                </div>
                ...
                <div class="mid-sl f-l">
                    ...
                    <input type="text" value="1" class="buygoodsnum" />
            ...
            <div class="info-mid">
                ...
                <div class="mid-sl f-l">
                    <a href="JavaScript:;" class="sl-left">-</a>
                    <input type="text" value="1" class="buygoodsnum" />
                    <a href="JavaScript:void(0)" class="sl-right">+</a>
                </div>
                <p class="mid-dj f-l">¥ <span>6</span>.00</p>
                <p class="mid-je f-l">¥ <span>6</span>.00</p>
                <div class="mid-chaozuo f-l">
