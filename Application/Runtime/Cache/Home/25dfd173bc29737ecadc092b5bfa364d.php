...
<div class="cart-content w1200">
    <form id="form1">
        <?php if(is_array($goodsInfo)): foreach($goodsInfo as $k1=>$v1): ?><!-- <if condition="$_SESSION['mid'] lt 0">-->
            <?php if(is_array($goodsInfo)): foreach($goodsInfo as $k=>$v): ?><div class="cart-con-info">
                    <div class="info-mid">
