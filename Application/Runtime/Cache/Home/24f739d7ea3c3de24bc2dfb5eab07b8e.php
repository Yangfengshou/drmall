...
<form id="form1">
    <div class="password-con registered">
       ...
       <input type="button" class="psw-btn" id="psw-btn" value="找回密码" style="text-align: center"/>
        <p class="sign-in">已找回？请<a href="login.html">登录</a><span style="padding-left: 130px">邮箱找回？请<a href="mailpwd.html">验证</a></span></p>
    </div>
</form>
    <!--底部服务-->
...
<script type="text/javascript">
    $(function(){
        $('#psw-btn').click(function(){
            $.post("<?php echo U('Login/serchpwdMy');?>",$('#form1').serialize(),function(data){
                if(data['status']==1){
