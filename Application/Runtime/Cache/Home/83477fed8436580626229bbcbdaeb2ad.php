...
<div class="personal w1200">
    ...
    <div class="member f-r">
        <div class="mem-info1">
            ...
            <div class="mem-con1">
                <dl class="f-l">
                    <dt><a href="#"><img src="/drmall/Public/home/images/data-tu2.gif" /></a></dt>
                    <dd>
                        <a href="#"><?php echo ($_SESSION['mname']); ?></a>
                        <span id="txt"></span>
                    </dd>
                    <div style="clear:both;"></div>
                </dl>
                <ul class="f-l">
                    <li>
                        <p>商城积分</p>
                        <span><?php echo ($data[0][vip_goods]); ?></span>
                    </li>
                    <li>
                        <p>总积分</p>
                        <span><?php echo ($data[0][vip_num]); ?></span>
                    </li>
                    <div style="clear:both;"></div>
                </ul>
                <a href="<?php echo U('Index/shopGradeActive');?>" class="duihuan f-l">兑换超值商品或参加活动</a>
                <div style="clear:both;"></div>
            </div>
        </div>
        <div class="mem-info2">
            ...
            <div class="mem-con2">
                <dl hpjf="gmsp">
                    <dt>
                    <h3>购买商品获得共<span><?php echo ($data[0][vip_goods]); ?>积分</span></h3>
                    <p>您可以通过购物下单获取积分</p>
                    </dt>
                    <dd>
                        <a href="<?php echo U('Index/index');?>">去商城购物</a>
                    </dd>
                    <div style="clear:both;"></div>
                </dl>
                <dl hpjf="cjhd">
                    <dt>
                    <h3>参加商城活动获得共<span><?php echo ($data[0][vip_active]); ?>积分</span></h3>
                    <p>您可以通过参加商城活动获取积分</p>
                    </dt>
                    <dd>
                        <a href="<?php echo U('Index/mallActive');?>">去商城活动</a>
                    </dd>
                    <div style="clear:both;"></div>
                </dl>
                <dl hpjf="qd">
                    <dt id="vip_1">
                    <h3>签到获得共 <span><?php echo ($data[0][vip_day]); ?>积分</span></h3>
                    <p>您可以通过每天签到获取积分</p>
                    </dt>
                    <dd>
...
<script>
    $('#day').on('click',function(){
        ...
        show_list();
        function show_list(){
            $.post("<?php echo U('Member/vip_1');?>",function(data){
                $("#vip_1").html(data);
            });
        }
    })
