...
<!--内容开始-->
<form method="post" action="<?php echo U('Login/pwd');?>">
    <div class="password-con registered">
        <div class="psw">
            <p class="psw-p1">密码：</p>
            <input type="password"  name="pwd" placeholder="新密码" /><span></span>
        </div>
        <div class="psw">
            <p class="psw-p1">密码：</p>
            <input type="password" name="pwd1" placeholder="重复新密码" value=""/><span></span>
        </div>
        <input type="submit" class="psw-btn" id="psw-btn" value="确认修改" style="text-align: center"/>
    </div>
</form>
<!--底部服务-->
