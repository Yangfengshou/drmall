        ...
        <div id="tab1" class="tabson">
            <form id="from1" method="POST">
                <div class="form-group mt0" style="margin-top: 30px; margin-left: 20px;">
                    ...
                    <input type="text" style="width: 280px;" name="title" id="title" value="<?php echo ($group_arr["title"]); ?>" class="form-input-small">
                </div>
...
<script>
    ...
    $("#add_auth").click(function(){
        ...
        if(menu_name==''){
            ...
            $.ajax({
                url: "<?php echo U('group_edit');?>?group_id=<?php echo $_GET['group_id']; ?>",
                ...
                success: function(data){
                    if(data[0]==1){
                        layer.msg("编辑成功",{icon: 1},function(){
                            location.href="<?php echo U('group_list');?>";
                        });
                    }else{
